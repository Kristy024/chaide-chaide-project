          ...
          Row(
            children: [
              IconButton(
                ...
                onPressed: () {
                   NavigationService.replaceTo('/dashboard/colchones/${ colchon.id }');
                }
              ),
              IconButton(
                ...
                onPressed: () {
                  ...
                  final dialog = AlertDialog(
                    ...
                    content: Text('¿Borrar definitivamente C. colchon ${ colchon.codigo }?'),
                    actions: [
                      TextButton(
                        child: Text('No'),
                        onPressed: () {
                      ...
                      TextButton(
                        ...
                        onPressed: () async {
                          await Provider.of<ColchonesProvider>(context, listen: false)
