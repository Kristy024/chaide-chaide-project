...
class _ColchonViewState extends State<ColchonView> {
 ...
 Colchones? colchon;
  ...
  void initState() { 
    ...
    final colchonProvider    = Provider.of<ColchonesProvider>(context, listen: false);


    colchonProvider.getColchonById(widget.uid)
      .then((userDB) {
  ...
  Widget build(BuildContext context) {
     ...
     final Colchones colchon2 = colchon ?? Colchones(estado: true,
      bordeTapaOndulado: false, 
      esquinaColSobresalida: false,
       esquinaTapaMalformada: false,
        hiloSueltoReata: false,
         hiloSueltoRemate: false, hiloSueltoAlcochado: false,
              ...
              ninguno: false,
               otros: false,
                ...
                presenciaHiloSuelto: false,
                 planAccion: "",
                  observacion: "",
                  id: "", codigo: "", lote: Lote(id: "0", codigo: "", modelo: ''), usuario: Usuario(id: "", nombre: ""), img: [], fechaIngreso: DateTime.now(), medidas: ''); // Valor de respaldo si colchon es null
      ...
      child: ListView(
        ...
        children: [
          ...
          SizedBox( height: 10 ),
            ...
            _ColchonViewBody(colchon: colchon2,)
...
class _ColchonViewBody extends StatelessWidget {
            ...
            WhiteCard(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('Fecha ingresado el control de fallo: ${DateFormat('yyyy, MMM d, HH:mm').format(colchon.fechaIngreso)}'),
                  SizedBox(height: 10),
  ...
  child: Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [for (int index = 0; index < colchon.img.length; index += 2)
  Padding(
            ...
            onTap: () {
              showDialog(
                ...
                builder: (context) => Dialog(
                  child: PhotoView(
                    imageProvider: NetworkImage(colchon.img[index]),
            ...
            child: GestureDetector(
              onTap: () {
                showDialog(
                  ...
                  builder: (context) => Dialog(
                    child: PhotoView(
                      imageProvider: NetworkImage(colchon.img[index + 1]),
                      loadingBuilder: (context, event) =>
                          Center(child: CircularProgressIndicator()),
                    ),
                  ),
