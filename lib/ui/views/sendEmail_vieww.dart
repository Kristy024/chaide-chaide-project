                        ...
                        onPressed: () async {
                          await showDialog(
                            ...
                            builder: (BuildContext context) {
                              TextEditingController _controller = TextEditingController(); // Controlador para manejar el valor del campo de texto
                              ...
                              return AlertDialog(
                                ...
                                actions: <Widget>[
                                  TextButton(
                                    child: Text('Cancelar'),
                                    onPressed: () {
                                      Navigator.of(context).pop(); // Cerrar el cuadro de diálogo sin comentario
                                    },
                                  ),
                                  TextButton(
                                    child: Text('Aceptar'),
                                    onPressed: () {
                                      String comentario = _controller.text; // Obtener el valor del campo de texto
