      ...
      theme: ThemeData.light().copyWith(
          ...
          dialogTheme: DialogTheme(
            shape: RoundedRectangleBorder(
              borderRadius: BorderRadius.circular(
                  25), // Bordes redondeados para el AlertDialog
            ),
            titleTextStyle: TextStyle(
                fontSize: 20,
                fontWeight: FontWeight.bold), // Estilo del texto del título
            contentTextStyle: TextStyle(
                fontSize: 16,
                color: Colors.black), // Estilo del texto del contenido
            backgroundColor:
                Colors.grey.shade100, // Color de fondo del AlertDialog
          ...
          dataTableTheme: DataTableThemeData(
            ...
            headingTextStyle: TextStyle(
                ...
                color: Colors.black), // Estilo de texto en el encabezado
            dataTextStyle: TextStyle(
                color: Colors.black), // Estilo de texto en las celdas de datos
